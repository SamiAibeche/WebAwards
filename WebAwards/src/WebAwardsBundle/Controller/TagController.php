...
use WebAwardsBundle\Entity\Tag;
use WebAwardsBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tags = $em->getRepository('WebAwardsBundle:Tag')->findAll();
    ...
    {
        $tag = new Tag();
        $form = $this->createForm('WebAwardsBundle\Form\TagType', $tag);
    ...
    {
        $deleteForm = $this->createDeleteForm($tag);
        $editForm = $this->createForm('WebAwardsBundle\Form\TagType', $tag);
